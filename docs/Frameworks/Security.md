...
![](pics/authentication.png)

**授权 (Authorization)：** 你有权限干什么。

![](pics/authorization.png)
...
![Session Based Authentication flow](pics/Session-Based-Authentication-flow.png)
...
![Token Based Authentication flow](pics/Token-Based-Authentication.png)
