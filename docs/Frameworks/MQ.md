...
![Message queue](pics/message-queue-small.png)
...
![通过异步处理提高系统性能](pics/Asynchronous-message-queue.png)
...
![点到点（P2P）模型](pics/162e7185572ca37d.gif)
　　
...
② 发布/订阅（Pub/Sub）模型
  ...
  ![发布/订阅（Pub/Sub）模型](pics/162e7187c268eaa5.gif)
　　
