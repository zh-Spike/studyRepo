...
![单点登录（SSO）设计](pics/sso-system.png-kblb.png)
...
![SSO系统设计-登录时序图](pics/sso-login-sequence.png-kbrb.png)
...
![SSO系统设计-登录信息获取/登录状态校验](pics/sso-logincheck-sequence.png-kbrb.png)
...
![SSO系统设计-用户登出](pics/sso-logout-sequence.png-kbrb.png)
...
![SSO系统设计-跨域登录（主域名已登录）](pics/sso-crossdomain-login-loggedin-sequence.png-kbrb.png)

- 跨域登录（主域名未登录）

![SSO系统设计-跨域登录（主域名未登录）](pics/sso-crossdomain-login-unlogin-sequence.png-kbrb.png)

- 跨域登出

![SSO系统设计-跨域登出](pics/sso-crossdomain-logout-sequence.png-kbrb.png)
