...
![ISP (Internet Service Provider) Definition](pics/b83f6951e3f8f4bcde5b227257d603a8.png)

5. **IXP（Internet eXchange Point）** ： 互联网交换点 IXP 的主要作用就是允许两个网络直接相连并交换分组，而不需要再通过第三个网络来转发分组。

![IXP Traffic Levels During the Stratos Skydive — RIPE Labs](pics/7a9568a9e94001fc110801addc8c4ec0.png)
...
![MAN & WMAN | Red de área metropolitana, Redes informaticas, Par trenzado](pics/25a5789f8e18995c649f2f864d51e7a9.png)
...
![Advantages and disadvantages of personal area network (PAN) - IT Release](pics/5c99dd6011439b1fab6cd2fece155dd5.png)
...
![](pics/20201025142342169.gif#pic_center)
...
![s](pics/2020102514243717.gif)

下面的内容会介绍计算机网络的五层体系结构：**物理层+数据链路层+网络层（网际层）+运输层+应用层**。

## 2. 物理层（Physical Layer）

![物理层](pics/4749289d6e152bab1c8a8ccfc946a797.png)
...
![](pics/c5be4756d2d6f46cbb6d785d5b86faf1.png)
...
![数据链路层](pics/8d24d1684552fa9cc824ce72b3087637.png)
...
7. **PPP（Point-to-Point Protocol ）** ：点对点协议。即用户计算机和 ISP 进行通信时所使用的数据链路层协议。以下是 PPP 帧的示意图：
   ![PPP](pics/298dbdeb16f98cec02c3954d8d95c1d6.png)
...
![ARP (Address Resolution Protocol) explained](pics/002b2e6e45d66e805008fafc310afef0.png)
...
![网络层](pics/fbf78bdcf3db11526ac1a234a8b98234.png)
...
![传输层](pics/09eb87a29bed99775ef5bde5eb216971.png)
...
![TCP和UDP](pics/2bd5bf90676c338864807ade87b7bdea.png)
...
![FTP工作过程](pics/3f1abf8adba4aa317eca69c489e3db23.png)
...
![万维网的大致工作工程](pics/735f55501e81898aa61b8032f7dbcb73.png)
...
![](pics/b273efef5f2388e26414135672b00295.png)
...
![一个电子邮件被发送的过程](pics/b16da4d4fea63de5fce53f54973967d7.png)
