...
![TCP三次握手](pics/三次握手.png)

**简单示意图：**

![TCP三次握手](pics/三次握手2.jpg)
...
![TCP、UDP协议的区别](pics/tcp-vs-udp.jpg)
...
<img src="pics/url输入到展示出来的过程.jpg" style="zoom:50%;" />
...
![各种协议与HTTP协议之间的关系](pics/各种协议与HTTP协议之间的关系.png)
